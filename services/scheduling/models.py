...
class BookingRequest(models.Model):
    ...
    custom_data = models.JSONField(default=dict, help_text="Additional data from source service")
...
class ResourceScheduleRule(models.Model):
    ...
    RULE_TYPES = [
        ...
        ('booking_window', 'Booking Time Window'),
    ]
    ...
    # Rule timing
    effective_start = models.DateTimeField(null=True, blank=True, help_text="When this rule becomes active")
    effective_end = models.DateTimeField(null=True, blank=True, help_text="When this rule expires")
